...
class TestDQNNetwork(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        network = DQNNetwork(
            state_size=self.state_size, action_size=self.action_size, hidden_layers=[128, 64]
        )
    ...
    def test_invalid_hidden_layers(self):
        ...
        with self.assertRaises(ValueError):
            DQNNetwork(state_size=self.state_size, action_size=self.action_size, hidden_layers=[])

        with self.assertRaises(ValueError):
            DQNNetwork(
                state_size=self.state_size, action_size=self.action_size, hidden_layers=[128, 0, 64]
            )

    def test_forward_pass(self):
        """Test forward pass through network."""
        network = DQNNetwork(state_size=self.state_size, action_size=self.action_size)
    ...
    def test_batch_norm(self):
        ...
        network = DQNNetwork(
            state_size=self.state_size, action_size=self.action_size, use_batch_norm=True
        )
    ...
    def test_dropout(self):
        ...
        network = DQNNetwork(
            state_size=self.state_size, action_size=self.action_size, dropout_rate=0.3
        )
...
class TestAgentLearningModel(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        model = AgentLearningModel(
            state_size=self.state_size, action_size=self.action_size, seed=42
        )
    ...
    def test_invalid_learning_rate(self):
        ...
        with self.assertRaises(ValueError):
            AgentLearningModel(
                state_size=self.state_size, action_size=self.action_size, learning_rate=0
            )

    def test_invalid_gamma(self):
        """Test error on invalid gamma."""
        with self.assertRaises(ValueError):
            AgentLearningModel(state_size=self.state_size, action_size=self.action_size, gamma=-0.1)

        with self.assertRaises(ValueError):
            AgentLearningModel(state_size=self.state_size, action_size=self.action_size, gamma=1.5)

    def test_invalid_epsilon(self):
        """Test error on invalid epsilon."""
        with self.assertRaises(ValueError):
            AgentLearningModel(
                state_size=self.state_size, action_size=self.action_size, epsilon=-0.1
            )
    ...
    def test_invalid_epsilon_decay(self):
        ...
        with self.assertRaises(ValueError):
            AgentLearningModel(
                state_size=self.state_size, action_size=self.action_size, epsilon_decay=0
            )
    ...
    def test_unsupported_device(self):
        ...
        with self.assertRaises(ValueError):
            AgentLearningModel(
                state_size=self.state_size, action_size=self.action_size, device="tpu"
            )

    def test_select_action_training(self):
        """Test action selection during training."""
        model = AgentLearningModel(
            state_size=self.state_size, action_size=self.action_size, epsilon=0.5, seed=42
        )
    ...
    def test_select_action_invalid_state(self):
        ...
        model = AgentLearningModel(state_size=self.state_size, action_size=self.action_size)
    ...
    def test_save_and_load_model(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Load into new model
            model2 = AgentLearningModel(state_size=self.state_size, action_size=self.action_size)
